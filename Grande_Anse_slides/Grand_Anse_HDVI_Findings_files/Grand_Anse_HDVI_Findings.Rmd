...
```{r Plots1, echo=FALSE}
cdplot(cat_hh_no_food_at_all3 ~ HDVI, Gran_Anse_1, col=c("lightslateblue","lightgreen"), main="Households that often experienced absence of food")
...
```{r Plots2, echo=FALSE}
 cdplot(cat_hh_no_food_at_all2 ~ HDVI, Gran_Anse_1, col=c("lightslateblue","lightgreen"), main="Households that sometimes experienced absence of food") 
...
```{r Plots3, echo=FALSE}
cdplot(cat_hh_day_no_food3 ~ HDVI, Gran_Anse_1, col= c("lightslateblue","lightgreen"), main="Forced to fast due to lack of food") 
...
cdplot(cat_hh_day_no_food2 ~ HDVI, Gran_Anse_1,  col= c("lightslateblue","lightgreen"), main="Households that were sometimes forced to fast due to lack of food") 
...
cdplot(cat_hh_bed_hungry3 ~ HDVI, Gran_Anse_1, col= c("lightslateblue","lightgreen"), main="Household that often go to bed hungry") 
...
cdplot(cat_hh_bed_hungry2 ~ HDVI, Gran_Anse_1, col= c("lightslateblue","lightgreen"), main="Household that sometimes go to bed hungry") 
```
